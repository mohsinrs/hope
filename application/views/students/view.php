                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="check-line">
                                <input type="radio" id="pmcEmail" class='icheck-me' name="rdoPMC" value="email" data-skin="square" data-color="blue" <?php if (isset($result)) echo $result->ContactMethod == 'email' ? 'checked' : '';
else echo 'checked'; ?>>
