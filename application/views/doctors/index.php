	...
	<div class="span12">
		<div class="box box-color box-bordered">
			<div class="box-title">
				...
				<div class="actions">
					<a href="/index.php/doctors/view" data-toggle="modal" class="btn">
                    ...
                    if(is_array($result)) {
                        foreach($result as $key => $value) { ?>
                            <tr>
                                ...
                                <td><a href="<?php echo base_url(); ?>index.php/doctors/view/<?php echo $value->DocterID; ?>" class="btn" rel="tooltip" title="" data-original-title="Edit"><i class="icon-edit"></i></a></td>
                            </tr>
                        <?php }
                        }
                    ?>
