    ...
    <div class="span12">
        <div class="box box-bordered">
            ...
            <div class="box-content nopadding">
                <form action="" method="POST" class='form-horizontal form-column form-bordered form-validate' id="frmOfferElective">
                    <div class="control-group">
                        <label for="cmbDoctor" class="control-label">Consultant</label>
                        <div class="controls">
                            <select name="cmbDoctor" id="cmbDoctor" class='input-large required' data-rule-required="true">
                                <option value="">Select One</option>
                                <?php if(is_array($doctors)):  ?>
                                    <?php foreach($doctors as $doctor):  ?>
                                        <option value="<?php echo $doctor->FirstName.' '.$doctor->LastName;?>"><?php echo $doctor->FirstName.' '.$doctor->LastName; ?></option>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </select>
                        </div>
                            ...
                            <select name="cmbSpeciality" id="cmbSpeciality" class='input-large' data-rule-required="true">
                                ...
                                <?php if( is_array($speciality) ) : ?>
                                    <?php foreach( $speciality as $spec ): ?>
                                        <option value="<?php echo $spec->SpecialityID; ?>"><?php echo $spec->Text; ?></option>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </select>
                        </div>
                    ...
                    <div class="control-group">
                        <label for="cmbYear" class="control-label">Year</label>
                        <div class="controls">
                            <select name="cmbYear" id="cmbYear" class='input-large required' data-rule-required="true">
                                <option value="">Select One</option>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="cmbState" id="cmbState" class='input-large required' data-rule-required="true">
                                <option value="">Select One</option>
                    ...
                    <div class="span12">
                        <div class="form-actions">
                            <button type="submit" name="submit" value="frmElectiveOfferSubmit" class="btn btn-primary">Save</button>
