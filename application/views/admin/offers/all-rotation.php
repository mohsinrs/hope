        ...
        <div class="box box-color box-bordered">
            ...
            <div class="box-title">
                ...
                <div class="pull-right">
                    <div class="actions">
                        <a href="<?php echo base_url('admin/offers/electives') ?>" data-toggle="modal" class="btn">
                            <i class="glyphicon-circle_plus"></i> Add Rotation</a>
                    </div>
                </div>
            </div>
                    ...
                    if (is_array($result)) {
                        foreach ($result as $key => $value) {
                            ...
                            <tr>
                                ...
                                <?php } else {
                                    ?><td> <?php echo $value->TotalStudent; ?></td> <?php }
                                ?>
